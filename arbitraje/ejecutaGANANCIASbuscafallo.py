...
for i in range(0, filas):
    ...
    if beneficioVCC>10:
        ...
        tic = time.time()
        print('VAMOS A EJECUTAR ORDEN 1 : ')
        #exchange.create_order(symbol1,type1,side1,amount1)
        print('VAMOS A EJECUTAR ORDEN 2 : ')
        #exchange.create_order(symbol2,type2,side2,amount2)
        print('VAMOS A EJECUTAR ORDEN 3 : ')
        #exchange.create_order(symbol3,type3,side3,amount3)
